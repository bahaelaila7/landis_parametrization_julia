...
function make_biomass_param_dists(n_species::Int, n_ecoregions::Int, eco_species_ids::Vector{Vector{Int}}; no_establishment::Bool=false, fit_establishment::Bool=false)
  ...
  params = [
    ...
    (FIX_GROWTH[] ? () : (MutableParam(:ANPP_MAX_SPP, DiscreteUniform(100, 1500), (100, 1500), 100, FloatType, EcoSpeciesSampler(), NestedIndexApplier(); group=:growth_biomass),))...,
    (FIX_GROWTH[] ? () : (MutableParam(:B_MAX_SPP, DiscreteUniform(15000, 30000), (15000, 30000), 1000, FloatType, EcoSpeciesSampler(), NestedIndexApplier(); quantum=100, group=:growth_biomass),))...,
