...
fl5 = DataFrame(DBInterface.execute(con, """
  ...
  WHERE c.agb>0
  GROUP BY c.statecd,c.unitcd,c.countycd,c.plot,c.epa_l3,c.land_use,
...
MK.save("runs/fig1_fl5_treemap_panels.png", fig1; px_per_unit = 3)
...
MK.save("runs/fig3a_fl5_treemap_aggregate.png", fig3; px_per_unit = 3)
...
println("wrote runs/fig1_fl5_treemap_panels.png + runs/fig3a_fl5_treemap_aggregate.png")
