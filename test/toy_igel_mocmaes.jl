...
function panelpair!(fig, col, name, f1, f2, st_mo, st_ig, frontf, a, b)
  # objective space (top)
...
let
  ...
  panelpair!(fig, 1, "convex front", fa1, fa2, moA, igA, frontA, A, B)
  panelpair!(fig, 2, "line front",   fc1, fc2, moC, igC, frontC, C, D)
